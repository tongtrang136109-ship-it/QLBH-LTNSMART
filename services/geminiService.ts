...
export async function getDiagnosticHelp(
  ...
  const parts: any[] = [
    { text: `Bạn là chuyên gia sửa xe máy. Triệu chứng: ${symptom}. Hãy phân tích nguyên nhân và đề xuất cách khắc phục bằng tiếng Việt, ngắn gọn, có cảnh báo an toàn.` },
  ];
  if (image) {
